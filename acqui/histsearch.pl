...
my $from_suggestion = $input->param('from_suggestion');
...
my ( $order_loop, $total_qty, $total_price, $total_qtyreceived ) = &GetHistory( $title, $author, $name, $ean, $isbn, $budget, $invoicenumber, $branchcode, $orderstatus, $from_iso, $to_iso, $from_suggestion );
