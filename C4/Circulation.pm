...
sub AddRenewal {
    ...
    unless ($datedue) {
        ...
        my $loanlength =
          GetLoanLength( $borrower->{'categorycode'}, ( C4::Context->preference('item-level_itypes') ) ? $biblio->{'itype'} : $biblio->{'itemtype'}, $issuedata->{'branchcode'} )
          ;    # that's the circ control branch.
